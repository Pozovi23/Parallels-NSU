...
void count_matrix(double* matrix_1, double* matrix_2) {
	...
	do {
      ...
      #pragma acc parallel loop collapse(2) present(matrix_1, matrix_2) 
			...
			double result = 0.0;
			#pragma acc parallel loop reduction(+:result)  present(matrix_2)
			for (int i = 0; i < (NX + 2) * (NY + 2); i++) {
...
int main(int argc, char *argv[]) {
	...
	#pragma acc enter data copyin(matrix_1[0:(NX + 2) * (NY + 2)], matrix_2[0:(NX + 2) * (NY + 2)])
  ...
  if (which_step) {
		#pragma acc update self(matrix_1[0:(NX + 2) * (NY + 2)])
		#pragma acc exit data delete(matrix_1[0:(NX + 2) * (NY + 2)], matrix_2[0:(NX + 2) * (NY + 2)])
    ...
    // }
		...
		#pragma acc update self(matrix_2[0:(NX + 2) * (NY + 2)])
		#pragma acc exit data delete(matrix_1[0:(NX + 2) * (NY + 2)], matrix_2[0:(NX + 2) * (NY + 2)])
